...
export interface DiscoverPageInitialData {
  items: EventFromApi[];
  total: number;
}
...
export default function DiscoverPageClient({
  ...
  initialData: DiscoverPageInitialData;
}) {
  const [events, setEvents] = useState<EventFromApi[]>(initialData.items);
  ...
  useEffect(() => {
    if (
      ...
      sortBy === "start_time" &&
      sortOrder === "asc" &&
      resolvedIsOnline === undefined &&
      resolvedPriceType === undefined &&
      resolvedDatePreset === undefined
    ) {
